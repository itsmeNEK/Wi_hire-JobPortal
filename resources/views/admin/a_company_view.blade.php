                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="text-center">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    @if ($company->ComType == '1')
                                        <h4>Small Business</h4>
                                    @elseif ($company->ComType == '2')
                                        <h4>Company</h4>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="picture-container">
                                <div class="picture">
                                    <img id="avatar" src="/company/images/{{ $company['prof_pic'] }}"
                                        alt="your image" class="picture-src" id="avatarPicturePreview" title="">
                                </div>
                            </div>
                            <br>
                            <!-- The image Modal -->
                            <div id="imagemodal" class="imagemodal">
                                <a class="closeimage btn btn-danger"
                                    style="display: flex; width:40px;padding-bottom:5px"><b>&times;</b></a>
                        ...
                        <div class="row sm-6">
                            <div class="col-sm-12"><label class="labels fw-bold">Company
                                    ...
                                    class="fw-bold text-center form-control" value="{{ $company['cname'] }}">
                            </div>
                            <div class="col-sm-12"><label class="labels fw-bold">Company
                                    Description</label>
                        ...
                        <br>
                        <div class="row mt-3">
                            <div class="col-md-6"><label class="labels fw-bold">Province</label><input type="text"
                                    name="province" disabled class="form-control" placeholder="Province"
                                    value="{{ $company['province'] }}">
                            </div>
                            <div class="col-md-6"><label class="labels fw-bold">City/Municipality</label><input
                                    name="city" type="text" disabled class="form-control"
                                    value="{{ $company['city'] }}" placeholder="City/Municipality">
                            </div>
                            <div class="col-md-6">
                                <label class="labels fw-bold">Barangay</label><input type="text" name="barangay"
                                    disabled class="form-control" placeholder="Barangay"
                                    value="{{ $company['barangay'] }}">
                            </div>
                            <div class="col-md-6"><label class="labels fw-bold">Street</label><input type="text"
                                    name="street" disabled class="form-control" value="{{ $company['street'] }}"
                                    placeholder="Street">
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a type="button" target="_blank"
                                                            href="/View_Company/{{ Crypt::encrypt($company['id']) }}/Viewfile/{{ Crypt::encrypt($info->id) }}"
