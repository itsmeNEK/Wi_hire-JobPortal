...
@section('title', 'Blocked Candidates')
            ...
            <div class="col-6 text-start">
                <div class="btn-group rounded" role="group" aria-label="Second group">
                    ...
                    <a href="{{ route('a_candidate') }}"><button type="button"
                            ...
                            <i class="bot3 bi bi-person-plus-fill"></i>
                            New
                        </button>
                    </a>
                    <a href="{{ route('a_candidate_verified') }}">
        ...
        <div class="d-flex justify-content-center">
            <div class="container rounded bg-white ">
                <div class="row" style="margin-top:45px;">
                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col-12 text-start">
                                    ...
                                    <a class=" text-danger" href="{{ route('a_candidate') }}">
                                        Active Candidates
                                    </a>/
                                    <a>
                                        Blocked Candidates
                                ...
                                <div class="p-3 py-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8 col-lg-8 text-start">
                                            <h4 class="">Blocked Candidates</h4>
                                        </div>
                                    </div>
                                    <hr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <a
                                                                href="Admin_view_Candidate/{{ Crypt::encrypt($info->id) }}"><button
                                                                    type="button"
                    ...
                    <!-- Modal -->
                    <form action="{{ route('a_candidate_unblocked') }}" method="post">
                        @csrf
