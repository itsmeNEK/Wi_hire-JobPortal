        ...
        <div class="row">
            <div class="card card-outline-secondary">
                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="d-flex text-left">
                                        <div class="p-3 py-5">
                                            <div class="align-items-center">
                                                <form action="{{ route('a_companies_approved') }}" method="GET">
                                                    <div class="search">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-sm-8 col-lg-8 text-left">
                                                    <h4 class="">Approved Companies</h4>
                                                </div>
                                            </div>
                                            <hr>
                    ...
                    <!-- Modal -->
                    <form action="{{ route('a_companies_block') }}" method="post">
                        @csrf
...
<script>
    ...
    $("#myModal").modal({
        ...
        $(this).find("#personDetails").html($("<input name=" + id + " hidden value=" + personId +
            "></input> <b>Are you sure you want to block this company?</b>"))
