...
<body style="background-color: rgb(255, 255, 255)">
    ...
    <div id="main">
        ...
        <div>
            <div class="company-section text-center pt-4 p-5 py-5 font-weight-bold">
                <div class="card-box-a">
                    <div class="container">
                        <i class="bi bi-chat-left-dots-fill"></i>
                    </div>
                    <h3 class="mt-2 text-danger font-weight-bold"> Customer-Centricity </h3>
                ...
                <div class="card-box-a">
                    ...
                    <h3 class="mt-2 text-danger font-weight-bold"> Transparency </h3>
                    <span class="text-md text-lg text-sm">
                ...
                <div class="card-box-a">
                    ...
                    <h3 class="mt-2 text-danger font-weight-bold"> Velocity </h3>
                    <span class="text-md text-lg text-sm">
                ...
                <div class="card-box-a">
                    ...
                    <h3 class="mt-2 text-danger font-weight-bold"> Diversity </h3>
                    <span class="text-md text-lg text-sm">
            ...
            <section class="mb-4">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 p-3 py-3 text-right">
                        ...
                        <br>
                        <hr>
                        <a class="btn btn-outline-light btn-floating m-1" href=""><i class="fab fa-github"></i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
