                ...
                <div class="row" style="margin-top:45px;">
                    <div class="com-md-4 col-md-offset-4">
                        <div class="card-header">
                            ...
                            <hr>
                            <main>
                                <form method="POST" action="{{ route('csend_mail') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="col-9 col-sm-10">
                                            <input type="email" class="form-control" id="to" name="to"
                                                value="{{ $mailInfo->from }}" placeholder="Type email">
                                            @error('to'){{ $message }}
                                            @enderror</span>
                                        </div>
                                    </div>
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="col-9 col-sm-10">
                                            <input type="text" class="form-control" id="to"
                                                value="{{ $mailInfo->subject }}" name="subject"
