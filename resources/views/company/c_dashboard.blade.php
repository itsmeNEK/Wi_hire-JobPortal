                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6 text-end dropdown"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark"
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('c_manage') }}">Manage
                                                        Jobs</a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="container rounded bg-success text-white">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6 text-end dropdown"
                                            style="margin-top:5px;margin-bottom:5px;"><br>
                                            <button style="font-size: 30px" class="btn btn-success" type="button"
                                                id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark"
                                                aria-labelledby="navbarDarkDropdownMenuLink">
                                                <li><a class="dropdown-item" href="{{ route('c_appManage') }}">View
                                                        Applicants</a></li>
                                                <li><a class="dropdown-item" href="{{ route('talent') }}">Talent
                                                        Search</a></li>
                                            </ul>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="row-mt-2">
                                                <div class="col-sm-12">
                                                    <div class="alert alert-dark text-lg-center " role="alert">
                                                        ...
                                                        <a href="{{ route('c_update') }}"
                                                            class="text-danger">Click
                                                            here</a>. <br>
                                                        You will be Redirected to the Profile page to upload a <br>
                                                        supporting document of having a proof or legal documents in
                                                        having a
                                                        business or company.
                                                        Thankyou. -Wihire
                                                    </div>
