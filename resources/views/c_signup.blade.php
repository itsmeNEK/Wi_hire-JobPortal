        ...
        <div class="inner">
            <form onSubmit="return checkPassword(this)" action="{{ route('c_save') }}" method="post">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput"><i class="bi text-danger bi-building"></i> Company / Business Name</label>
                ...
                <div class="form-floating  mb-3">
                    <select name="ComType" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                      <option selected>Click this select menu</option>
                      <option value="1">Small Business</option>
                      <option value="2">Company</option>
                    </select>
                    <label for="floatingSelect"><i class="bi bi-globe text-danger"></i> Company Type</label>
                  </div>
                <div class="form-floating mb-3">
